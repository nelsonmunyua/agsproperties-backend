...
Revision ID: d85e2d3eb2e8
Revises: 
Create Date: 2026-07-30 10:29:20.214381
...
def upgrade():
    ...
    sa.UniqueConstraint('property_id', name=op.f('uq_property_locations_property_id'))
    )
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.ForeignKeyConstraint(['property_id'], ['properties.id'], name=op.f('fk_property_videos_property_id_properties')),
